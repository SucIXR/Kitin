...
- **默认值:** `-1`
- **说明:** 
    - 限制服务器每 Tick 向所有玩家发送区块包的总量。如果你的服务器带宽较小或者吃紧，**强烈建议设置此项**，能显著降低服务器延迟峰值抖动，提高游戏体验(前提你服务器网络没有跨网QoS问题)
    - **计算公式:** `服务器上行带宽(Mbps) * 0.6(地形占用带宽比例,一般来说可高达99%，如果挂机很多则低) / (平均区块大小KB * 20)`
      *(简单来说：直接填写你的服务器带宽 Mbps*0.6(向下取整) 即可，例如 30Mbps 就填 18，没有进行仔细测量，以实际为准)*
